...
- SWE side - Current status in internship:
  ...
  - Learning CSS ([**GitHub Link**](https://github.com/Stella-Liyu-Zhang/Portfolio)) and built a site that is hosted [**HERE**](https://stella-liyu-zhang.github.io/Portfolio/).
  - Rebuilt 3 versions of PINT.com and chose one of them for review. ([**GitHub Link**]())

> **Reflections**: I have always wanted to be a web developer with both **strong product sense** and **emphasize on maximizing User Experience**. During my time at PINT, I got to know how to elevate user's experience in web development.
...
- PM side - Current status in internship:
  ...
  - My major responsibilities include: task making, clarifying requirements for dev, shipping progress to clients.
...
- **Process:**
  ...
  - First, to ensure that I fully, thoroughly, 100% understand what the client is looking for in this requirement.
    - Understand why the client want this new feature or change. Some motivations include:
      - An increase in
        ...
        - Subscription of premium services
        - Other relative metrics.
      - User Experience.
      - Competitive products have a similar feature updated in their latest version.
      - An expansion/recession in the target user group.
  ...
  - Ship to client and get client's feedback
  - Review feedback and repeat previous steps.

- **An example:**
  When building the OD articles and resources page, the whole development process lasted for 3 weeks, because there were constant feedback from our client.

  For instance, to remove button, add new button, prioritize the articles. change texts, titles, positions on OD resources.
  Tabbing features are not prioritized.

### **Prioritize** my tasks.

- **How to prioritize my tasks?**
  - Objective: As a PM and a potential SWE, time management is super important.
...
- Throught my internship I raised a question:

1.  What if in the middle of a project we have already spent 60% of the budget? How do we make sure that we ship the product to client without adding extra money?

- **What I could in this case:**
  - Let the client know
    - There are holidays in the second half of the year (maybe?)
  - Let the Dev team know
    - They shall probably be more proficient with their work??
    - But do not pressure them, make sure the quality of delivery is promised.
    - If there are any case, we may want to give up less prioritized features??
- **Goal**

  - Find a balance between overloading the dev team, and deliver as much as possible to make sure our clients are satisfied.
  - In a nutshell, make sure our dev team and clients are both happy (PM is that one person in the middle ooof)

### **Handle an emergency/PR Crisis**

How to manage an emergency could be divided into 2 parts:

- How to talk to clients (Handle a PR Crisis)

- How to efficiently solve the problem on time
